          ...
          <div className={isChatOpen ? "chat-container chat-container--visible" : "chat-container"}>
            ...
            <div ref={chatLogElement} className="chat-log">
                {messageLog.map((item, index) => {
                    return(
                        <div key={index} className={item.selfMassage ? "chat-message chat-message--self " : "chat-message"}>
            ...
            <form onSubmit={handleChatSubmit}>
              <input value={userMassage} ref={chatFiled} onChange={handleInputChange} type="text" autoComplete="off" placeholder="Your message here" />
            </form>
          </div>
        </>
    )
